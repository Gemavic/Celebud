...
INSERT INTO categories (name, slug, icon, color) VALUES
  ...
  ('Canada', 'canada', 'map-pin', '#DC2626'),
  ('Immigration', 'immigration', 'globe', '#3B82F6')
ON CONFLICT (slug) DO NOTHING;

-- Insert news sources for Canadian and diverse news
