        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-white mb-4">
              ...
              <span className="text-red-400">Earn 30% of ad revenue.</span>
            </h2>
            <p className="text-gray-300 text-sm mb-4 leading-relaxed">
              Join our creator program and earn money from every article you publish.
              We split ad revenue 70/30 — you write, we handle distribution, you get paid monthly.
            </p>
            <p className="text-gray-400 text-xs mb-8 leading-relaxed">
              Report <em>and</em> produce video or audio for us? Your share rises to{' '}
              <strong className="text-red-400">45%</strong> — a premium for doing both jobs.
            </p>
            <div className="grid grid-cols-3 gap-4 mb-8">
              <div className="text-center p-3 bg-white/5 rounded-xl">
                <DollarSign className="w-5 h-5 text-green-400 mx-auto mb-1.5" />
                <p className="text-white text-xs font-semibold">70/30 Split</p>
                <p className="text-gray-400 text-[10px] mt-0.5">30% to you, monthly</p>
              </div>
              <div className="text-center p-3 bg-white/5 rounded-xl">
