      ...
      <article className="pt-32 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center space-x-4">
              {article.authors && (
                <>
                  ...
                  />
                  <div>
                    <p className="font-semibold text-gray-900">{article.authors.name}</p>
                    <p className="text-sm text-gray-500">{article.authors.role}</p>
                  </div>
                </>
              )}
            </div>
          ...
          <div className="prose prose-lg max-w-none mb-12">
            <p className="text-xl text-gray-700 leading-relaxed mb-6">{article.description}</p>
            ...
            {article.source_url && (
              <div className="mt-8 p-6 bg-gray-50 rounded-xl border border-gray-200">
                <p className="text-sm text-gray-600 mb-2">Read the full article at:</p>
                <a
