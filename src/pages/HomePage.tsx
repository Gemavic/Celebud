...
import { WHATSAPP_CHANNEL_URL } from '../components/SocialLinks';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-green-600/20 border border-green-500/30 rounded-2xl p-6 mb-10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-bold text-white text-base">Follow Celebud Media on WhatsApp</p>
                <p className="text-green-300 text-sm">Get breaking news delivered directly to your WhatsApp — free, no spam.</p>
              </div>
            </div>
            <a
              ...
              className="flex-shrink-0 bg-green-500 hover:bg-green-400 text-white font-bold px-6 py-3 rounded-full transition-colors text-sm whitespace-nowrap"
            >
              Join Channel
            </a>
          </div>
